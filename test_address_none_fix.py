...
async def test_address_none_fix():
    ...
    try:
        person_update = PersonUpdate(
            ...
            address=None  # This should be allowed
        )
        print(f"✅ PersonUpdate created successfully: {person_update.model_dump(exclude_unset=True)}")
            ...
            if field == "address":
                ...
                if value is not None:
                    if hasattr(value, 'model_dump'):
                        ...
                        print(f"   Address model_dump() successful: {list(address_dict.keys())}")
                    else:
