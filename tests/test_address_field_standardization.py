...
class TestAddressFieldStandardization:
    ...
    def test_dynamodb_address_normalization_for_storage(self):
        ...
        for test_case in test_cases:
            normalized = db_service._normalize_address_for_storage(test_case["input"].copy())
            ...
            if original_field != "postal_code":
                assert original_field not in normalized, f"Original field {original_field} should be removed"
    ...
    def test_dynamodb_item_to_person_conversion(self):
        ...
        for i, item in enumerate(test_items):
            ...
            assert person.address.postal_code == expected_postal_codes[i], \
    ...
    def test_legacy_data_migration_compatibility(self):
        ...
        for i, legacy_data in enumerate(legacy_data_variations):
            ...
            assert person.address.postal_code == legacy_data["expected"], \
