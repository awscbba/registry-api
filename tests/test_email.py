...
async def test_email_service():
    ...
    print(f"📧 SES From Email: {os.getenv('SES_FROM_EMAIL', 'noreply@people-register.local')}")
    print(f"🌐 AWS Region: {os.getenv('AWS_REGION', 'us-east-1')}")
    print(f"🔗 Frontend URL: {os.getenv('FRONTEND_URL', 'https://d28z2il3z2vmpc.cloudfront.net')}")
