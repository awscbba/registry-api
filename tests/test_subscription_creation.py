...
# Integration test - temporarily skipped until repository pattern is deployed
@pytest.mark.skip(reason="Temporarily skipping until repository pattern is deployed")
