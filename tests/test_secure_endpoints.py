...
class TestSecureEndpoints:
    ...
    def test_login_account_locked(self, client):
        ...
        with patch('src.services.dynamodb_service.DynamoDBService.get_person_by_email') as mock_get:  # noqa: E501
    ...
    def test_protected_endpoint_with_invalid_token(self, client, mock_jwt_handler):  # noqa: E501
        """Test accessing protected endpoint with invalid token"""
        # Mock JWT validation to raise an exception
        with patch('src.utils.jwt_utils.JWTManager.verify_token') as mock_validate:  # noqa: E501
    ...
    def test_protected_endpoint_with_expired_token(self, client, mock_jwt_handler):  # noqa: E501
    ...
    def test_password_change_required(self, client, mock_jwt_handler, sample_person):  # noqa: E501
        ...
        with patch('src.services.dynamodb_service.DynamoDBService.get_person') as mock_get:  # noqa: E501
            mock_get.return_value = sample_person

            with patch('src.utils.jwt_utils.JWTManager.verify_token') as mock_verify:  # noqa: E501
    ...
    def test_cross_user_access_prevention(self, client, mock_jwt_handler, sample_person):  # noqa: E501
