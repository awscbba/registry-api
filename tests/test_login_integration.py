...
class TestLoginIntegration:
    ...
    def test_login_success(self, client, mock_person_with_password):
        ...
        with patch('src.handlers.people_handler.auth_service.authenticate_user', new_callable=AsyncMock) as mock_auth:
    ...
    def test_protected_endpoint_without_token(self, client):
        ...
        assert response.status_code == 403  # Auth middleware returns 403 for missing token
    ...
    def test_protected_endpoint_with_valid_token(self, client, mock_person_with_password):
        ...
        assert response.status_code == 401  # Expected in test environment without proper JWT setup
        data = response.json()
