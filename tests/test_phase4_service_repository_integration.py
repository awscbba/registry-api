...
class TestPhase4ServiceRepositoryIntegration:
    ...
    @pytest.mark.asyncio
    async def test_people_service_initialize_with_repository(self, mock_user_repository):
    ...
    @pytest.mark.asyncio
    async def test_people_service_health_check_with_repository(self, mock_user_repository):
    ...
    @pytest.mark.asyncio
    async def test_projects_service_initialize_with_repository(self, mock_project_repository):
    ...
    @pytest.mark.asyncio
    async def test_projects_service_health_check_with_repository(self, mock_project_repository):
    ...
    @pytest.mark.asyncio
    async def test_audit_service_initialize_with_repository(self, mock_audit_repository):
    ...
    @pytest.mark.asyncio
    async def test_audit_service_health_check_with_repository(self, mock_audit_repository):
    ...
    async def test_repository_error_handling(self, mock_user_repository):
        ...
        mock_user_repository.count.return_value = AsyncMock(success=False, error="Connection failed")
