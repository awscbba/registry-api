...
class TestPersonUpdateAddressFix:
    ...
    def test_person_update_with_address_response_formatting(self, mock_db_service, client):
    ...
    def test_address_model_field_access(self):
        ...
        assert postal_code_value == "12345", "Should be able to access postal_code field"
        assert "postal_code" in dumped, "model_dump should use actual field names"
        assert "postalCode" in dumped_by_alias, "model_dump(by_alias=True) should use aliases"