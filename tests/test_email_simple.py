...
def test_ses_configuration():
    ...
    from_email = os.getenv('SES_FROM_EMAIL', 'srinclan@gmail.com')  # Use verified Gmail as default
    ...
    try:
        ...
        print(f"📊 SES Quota - Max24Hour: {quota['Max24HourSend']}, MaxSendRate: {quota['MaxSendRate']}, SentLast24Hours: {quota['SentLast24Hours']}")
    ...
    try:
        ...
        response = ses_client.send_email(
            ...
            Message={
                'Subject': {'Data': 'Test Email from People Registry', 'Charset': 'UTF-8'},
                'Body': {
                    'Html': {
