...
def test_person_update_api():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if response.status_code == 500:
                print("   🚨 This might be the address field issue we're investigating!")
            return False
    ...
    update_data_none_address = {
        "firstName": "None Address Test",
        "address": None
    }
