...
def traced_lambda_handler(event, context):
    ...
    try:
        ...
        if XRAY_ENABLED:
            ...
            add_annotation('function_name', context.function_name if context else 'unknown')
            ...
            add_metadata('lambda', 'request_id', context.aws_request_id if context else 'unknown')
