...
class ResponseFormatter:
    ...
    def not_found_response(
        resource_type: str = "Resource", request_id: Optional[str] = None
    ) -> HTTPException:
        """
    ...
    def internal_server_error_response(
        message: str = "An unexpected error occurred", request_id: Optional[str] = None
    ) -> HTTPException:
        """
    ...
    def convert_dict_keys(data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for key, value in data.items():
            ...
            if isinstance(value, dict):
                ...
                converted[camel_key] = [
                    (
                        CamelCaseConverter.convert_dict_keys(item)
...
def create_person_response(person_data: Dict[str, Any]) -> JSONResponse:
    ...
    return ResponseFormatter.success_response(
        data=camel_case_data, status_code=HTTPStatusCodes.CREATED
    )
