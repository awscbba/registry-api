...
class SubscriptionBase(BaseModel):
    ...
    notes: Optional[str] = Field(None, max_length=500, description="Additional notes about the subscription")
...
class SubscriptionResponse(SubscriptionBase):
    ...
    projectName: Optional[str] = Field(None, description="Name of the subscribed project")
...
class SubscriptionWithDetails(SubscriptionResponse):
    ...
    personEmail: Optional[str] = Field(None, description="Email of the subscribed person")
    personPhone: Optional[str] = Field(None, description="Phone of the subscribed person")
    projectDescription: Optional[str] = Field(None, description="Description of the subscribed project")
    projectStartDate: Optional[str] = Field(None, description="Start date of the subscribed project")
    projectEndDate: Optional[str] = Field(None, description="End date of the subscribed project")
