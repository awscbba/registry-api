...
class ProjectBase(BaseModel):
    ...
    maxParticipants: int = Field(..., ge=1, le=1000, description="Maximum number of participants")
...
class ProjectUpdate(BaseModel):
    ...
    description: Optional[str] = Field(None, min_length=1, max_length=1000, description="Project description")
    startDate: Optional[str] = Field(None, description="Project start date (YYYY-MM-DD)")
    endDate: Optional[str] = Field(None, description="Project end date (YYYY-MM-DD)")
    maxParticipants: Optional[int] = Field(None, ge=1, le=1000, description="Maximum number of participants")
