...
from ..models.person import (
    ...
    PersonSearchRequest, PersonSearchResponse, EmailVerificationRequest
)
...
from ..utils.handler_utils import (
    create_error_context, log_person_operation_with_context,
    log_authentication_with_context, log_password_event_with_context,
    log_security_event_with_context, check_rate_limit_for_endpoint,
    create_person_not_found_exception, create_validation_exception_from_errors,
    create_authentication_exception, create_password_policy_exception,
    create_email_already_exists_exception, handle_service_error,
    log_person_list_access, log_person_access, log_person_update_audit
)
...
async def login(login_request: LoginRequest, request: Request):
    ...
    try:
        ...
        await log_security_event_with_context(
            ...
            request=request,
            user_id=login_response.user_id if hasattr(login_response, 'user_id') else None,
...
async def update_password(
    ...
    await check_rate_limit_for_endpoint(RateLimitType.PASSWORD_CHANGE, request, current_user.id)
...
async def list_people(
    ...
    # Check rate limits
    await check_rate_limit_for_endpoint(RateLimitType.API_REQUESTS, request, current_user.id)
...
async def create_person(
    ...
    await check_rate_limit_for_endpoint(RateLimitType.PERSON_CREATION, request, current_user.id)
    ...
    try:
        ...
        if not validation_result.is_valid:
            field_errors = {error.field: error.message for error in validation_result.errors}
...
async def update_person(
    ...
    await check_rate_limit_for_endpoint(RateLimitType.PERSON_UPDATES, request, current_user.id)
...
async def search_people(
    ...
    await check_rate_limit_for_endpoint(RateLimitType.SEARCH_REQUESTS, request, current_user.id)
...
async def initiate_email_verification(
    ...
    await check_rate_limit_for_endpoint(RateLimitType.EMAIL_VERIFICATION, request, current_user.id)
    ...
    try:
        ...
        raise await handle_service_error(e, "initiate_email_verification", request, current_user.id)
