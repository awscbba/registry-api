...
class SecurityDashboardHandler:
    ...
    @require_admin_auth
    def get_security_overview(self, event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    @require_admin_auth
    def get_security_alerts(self, event: Dict[str, Any], context: Any) -> Dict[str, Any]:
        ...
        try:
            ...
            if severity not in valid_severities:
                return error_response(400, f"Invalid severity. Must be one of: {', '.join(valid_severities)}")
    ...
    @require_admin_auth
    def get_failed_login_details(self, event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    @require_admin_auth
    def unlock_user_account(self, event: Dict[str, Any], context: Any) -> Dict[str, Any]:
        ...
        try:
            ...
            admin_email = event.get('requestContext', {}).get('authorizer', {}).get('email')
            if not admin_email:
    ...
    @require_admin_auth
    def create_security_event(self, event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    @require_admin_auth
    def get_user_security_profile(self, event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    def get_dashboard_health(self, event: Dict[str, Any], context: Any) -> Dict[str, Any]:
