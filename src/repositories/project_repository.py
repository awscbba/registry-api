...
class ProjectRepository(BaseRepository[Project]):
    ...
    def _to_item(self, entity: Project) -> Dict[str, Any]:
        ...
        optional_fields = [
            'created_at', 'updated_at', 'start_date', 'end_date', 'budget', 'tags'
        ]
    ...
    async def get_by_status(self, status: str) -> RepositoryResult[List[Project]]:
        ...
        filters = [QueryFilter(field="status", operator=QueryOperator.EQUALS, value=status)]
    ...
    async def get_by_creator(self, creator_id: str) -> RepositoryResult[List[Project]]:
        ...
        filters = [QueryFilter(field="created_by", operator=QueryOperator.EQUALS, value=creator_id)]
        options = QueryOptions(filters=filters)
