...
class ValidationResult:
    ...
    def add_error(self, field: str, message: str, code: ValidationErrorType, value: str = None):
...
class PersonValidationService:
    ...
    async def validate_person_create(self, person_data: PersonCreate) -> ValidationResult:
        """
        ...
        self._validate_name_fields(person_data.first_name, person_data.last_name, result)

        return result

    async def validate_person_update(self, person_id: str, person_data: PersonUpdate) -> ValidationResult:
        """
        ...
        if person_data.email is not None:
            await self._validate_email(person_data.email, result, exclude_person_id=person_id)
    ...
    async def validate_email_uniqueness(self, email: str, exclude_person_id: str = None) -> bool:
        """
    ...
    def _validate_required_fields(self, person_data: PersonCreate, result: ValidationResult):
    ...
    async def _validate_email(self, email: str, result: ValidationResult, exclude_person_id: str = None):
        """Validate email format and uniqueness."""
        if not email:
            result.add_error(
                field='email',
    ...
    def _validate_name_fields(self, first_name: str, last_name: str, result: ValidationResult, allow_none: bool = False):
        ...
        for field_name, name_value in [('first_name', first_name), ('last_name', last_name)]:
