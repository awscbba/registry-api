...
from ..utils.defensive_utils import (
    ...
    safe_model_dump, database_operation, safe_update_expression_builder,
    validate_required_fields, sanitize_for_logging
)
...
class DefensiveDynamoDBService:
    ...
    def _safe_person_to_item(self, person: Person) -> Dict[str, Any]:
        ...
        try:
            ...
            item["requirePasswordChange"] = safe_field_access(person, 'require_password_change', False)
            item["failedLoginAttempts"] = safe_field_access(person, 'failed_login_attempts', 0)
    ...
    def _safe_item_to_person(self, item: Dict[str, Any]) -> Person:
        ...
        try:
            ...
            person_data = {
                ...
                "createdAt": safe_datetime_parse(item.get("createdAt")) or datetime.utcnow(),
                "updatedAt": safe_datetime_parse(item.get("updatedAt")) or datetime.utcnow(),
            }
            ...
            if item.get("lastPasswordChange"):
                person.last_password_change = safe_datetime_parse(item["lastPasswordChange"])
            
            if item.get("accountLockedUntil"):
                person.account_locked_until = safe_datetime_parse(item["accountLockedUntil"])
    ...
    async def create_person(
        ...
        try:
            ...
            raise Exception(f"Failed to create person: {e.response['Error']['Message']}")
        except Exception as e:
    ...
    async def update_person(
        ...
        try:
            ...
            update_expression, expression_values, expression_names = safe_update_expression_builder(
            ...
            if "address" in update_data:
                ...
                if address_value is not None:
                    ...
                    normalized_address = self._normalize_address_for_storage(address_dict)
            ...
            raise Exception(f"Failed to update person: {e.response['Error']['Message']}")
        except Exception as e:
    ...
    def create_project(self, project_data: ProjectCreate, created_by: str = "system") -> Dict[str, Any]:
        ...
        try:
            ...
            required_fields = ["name", "description", "startDate", "endDate", "maxParticipants"]
    ...
    def create_subscription(self, subscription_data: SubscriptionCreate) -> Dict[str, Any]:
        ...
        try:
            ...
            missing_fields = validate_required_fields(subscription_dict, required_fields)
