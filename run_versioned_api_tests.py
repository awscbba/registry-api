...
def run_tests():
    ...
    test_configs = [
        {
            "name": "Unit Tests",
            "args": ["-v", "-m", "unit", "--tb=short"]
        },
        {
            "name": "Async Tests", 
            "args": ["-v", "-m", "async_test", "--tb=short"]
        },
        {
        ...
        },
        {
            ...
            "args": ["-v", "--cov=src/handlers", "--cov-report=term-missing", "--tb=short"]
        }
    ]
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                if result.stdout:
                    ...
                    summary_lines = [line for line in lines if 'passed' in line and ('failed' in line or 'error' in line or 'warnings' in line)]
                    if summary_lines:
