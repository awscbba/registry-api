...
PERSON_ID = (
    "8a22f71c-b3ba-46f0-912a-8eb44b1037ac"  # The failing person ID from frontend
)
...
def test_person_update_scenarios():
    ...
    problematic_scenarios = [
        {"name": "Empty strings", "data": {"firstName": "", "lastName": ""}},
        {"name": "Null values", "data": {"firstName": None, "lastName": None}},
        {
            "name": "Missing address fields",
            "data": {"firstName": "Test", "lastName": "Missing Address", "address": {}},
        },
        {
