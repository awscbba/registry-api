    ...
    try:
        ...
        if existing_user:
            ...
            if getattr(existing_user, 'is_admin', False):
                ...
                updated_user = await db_service.update_person(existing_user.id, update_data)
...
async def create_test_admin_user():
    ...
    try:
        ...
        # Create password hash
        password_hash, password_salt = password_hasher.hash_password(test_admin_password)
        ...
        print(f"   Name: {created_test_admin.first_name} {created_test_admin.last_name}")
